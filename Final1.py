    ...
    def main(self):
        ...
        class FailDeath:
            ...
            def update_display(self):
                ...
                self.screen.blit(pygame.image.load('Data/death.png'), (180, 90))
                ...
                x = 50
                y = 360
                self.screen.blit(SmallFront.render('Эх ты, а еще за Рыцаря', 0, c), (x+60, y))
                self.screen.blit(SmallFront.render('себя выдаешь...', 0, c), (x+110 + 30, y + 30))
                #self.screen.blit(SmallFront.render('а сам же ее своею рукой и погубил!', 0, c), (x - 10, y  + 60))

                # Parameters:               surface,      color,       x,   y,   length, height, width,    text,      text_color
                self.try_again.create_button(self.screen, (60, 142, 255), 50, 460, 500, 50, 0, 'Я воскреcну и спасу возлюбленную!',
                                           (255, 255, 255))
                pygame.display.flip()
